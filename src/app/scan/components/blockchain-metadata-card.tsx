...
export function BlockchainMetadataCard({
  ...
  return (
    <Card className="mb-6 border-0 bg-linear-to-br from-indigo-500/10 via-indigo-500/5 to-transparent shadow-lg shadow-indigo-500/5 overflow-hidden relative">
      ...
      <CardHeader className="pb-3 relative">
        <CardTitle className="text-base sm:text-lg flex items-center gap-2">
          <div className="h-8 w-8 rounded-lg bg-linear-to-br from-indigo-500 to-blue-600 flex items-center justify-center shadow-md shadow-indigo-500/20">
